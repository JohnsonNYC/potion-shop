...
*/
// INV TILE className="inventory-card"
// SHOP TILE className="card"
const PotionTile = (props) => {


  return (
    <div key={props.potion.id} className={props.style}>
      <div onClick={props.style==='inventory-card'? () => props.sell(props.potion.id): () => props.addToInventory(props.potion.id)} className="image-wrapper">
...
//        -ShopTile / PotionTile
//    - Inventory 
//        - Inventory Tile / PotionTile
// if classname == inv card
//    onclick = sell(x)
//  else
//    onClick= addToInv